    ...
    def evaluate(self, quesIds=None):
        ...
        for quesId in quesIds:
            ...
            for gtAnsDatum in gts[quesId]["answers"]:
                ...
                #matchingAns = [item for item in otherGTAns if resAns==item["answer"]]
                matchingAns = [item for item in otherGTAns if (resAns[:len(item["answer"])]==item["answer"] or all(it.lower() in resAns  for it in item["answer"].split()))]
